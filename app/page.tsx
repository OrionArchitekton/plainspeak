...
export default function Home() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-10 sm:py-16">
      ...
      {result && (
        <section className="mt-6 space-y-4 rise">
          <Card title="In plain words" accent="from-violet-400 to-violet-600">
          ...
          {result.affectsYou.length > 0 && (
            <Card title="What affects you" accent="from-rose-400 to-amber-500">
          ...
          {result.questions.length > 0 && (
            <Card title="Questions to ask" accent="from-sky-400 to-emerald-500">
